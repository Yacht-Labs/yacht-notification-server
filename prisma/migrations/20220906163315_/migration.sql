...
CREATE TABLE "EulerIRNotification" (
    ...
    "borrowUpperThreshold" INTEGER,
    "borrowLowerThreshold" INTEGER,
    "supplyUpperThreshold" INTEGER,
    "supplyLowerThreshold" INTEGER,
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "EulerIRNotification" ADD CONSTRAINT "EulerIRNotification_tokenAddress_fkey" FOREIGN KEY ("tokenAddress") REFERENCES "EulerToken"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
